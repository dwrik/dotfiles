...
![Arch Linux Rice Screenshot](https://github.com/dwrik/dotfiles/blob/archlinux/.local/share/screenshot)
...
- dmenu based emoji picker: [emojimenu](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/emojimenu)
- spotlight like search menu: [search](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/search)
- choose/set wallpaper & change colorscheme: [wallpaper](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/wallpaper)
- fix permissions & names: [fixfiles](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/fixfiles)
- screenshots: [sniping-tool](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/sniping-tool)
- power options: [powermenu](https://github.com/dwrik/dotfiles/blob/archlinux/.local/bin/powermenu)
